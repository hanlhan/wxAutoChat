...
* [2.支持向量机](统计学习/chapters/2_svm.html)
    * 一、 线性可分支持向量机
    * 二、线性支持向量机
    * 三、非线性支持向量机
    * 四、支持向量回归
...
* [10.降维](统计学习/chapters/10_PCA.html)
    * 一、维度灾难
    * 二、主成分分析 PCA
    * 三、核化线性降维 KPCA
    * 四、流形学习
...
* [6.循环神经网络](深度学习/chapters/6_RNN.html)
    * 一、RNN计算图
    * 二、循环神经网络
    * 三、长期依赖
    * 四、序列到序列架构
...
* [xgboost使用指南](工具/xgboost/chapters/xgboost_usage.html)
    * 一、安装
    * 二、调参
    * 三、外存计算
    * 四、 GPU计算
...
* [7.隐马尔可夫模型](工具/scikit-learn/chapters/7.HMM.html)
    * 一、Hmmlearn
    * 二、seqlearn
